          ...
          <div className="w-full px-4 md:w-1/2 lg:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 10.8c-1.08-2.16-4.32-6.48-8.64-6.48-1.08 0-2.16.27-2.16 1.35 0 1.08 1.08 1.62 1.62 1.89C4.32 8.37 6.48 10.53 6.48 12.15c0 1.62-2.16 3.78-3.66 4.59-.54.27-1.62.81-1.62 1.89 0 1.08 1.08 1.35 2.16 1.35 4.32 0 7.56-4.32 8.64-6.48 1.08 2.16 4.32 6.48 8.64 6.48 1.08 0 2.16-.27 2.16-1.35 0-1.08-1.08-1.62-1.62-1.89-1.5-1.08-3.66-3.24-3.66-4.86 0-1.62 2.16-3.78 3.66-4.59.54-.27 1.62-.81 1.62-1.89 0-1.08-1.08-1.35-2.16-1.35-4.32 0-7.56 4.32-8.64 6.48z" />
                  </svg>
                </a>
              </div>
            </div>
