        ...
        <div className={styles.card}>
            <div className={styles.topSection}>
                ...
                <div className={styles.icons}>
                    <div className={styles.logo}>CYCLOSPACE</div>
                ...
                <div className={styles.glitchContainer}>
                    <LetterGlitch
                        glitchColors={["#f2721c", "#ffffff", "#f9a443"]}
                        glitchSpeed={50}
                        centerVignette
                        outerVignette
                        smooth
            ...
            <div className={styles.bottomSection}>
                <span className={styles.title}>Implementation</span>

                <div className={styles.row}>
                    <div className={styles.item}>
                        <span className={styles.bigText}>v1.0</span>
                        <span className={styles.regularText}>CORE</span>
                    </div>
                    <div className={styles.item}>
                        <span className={styles.bigText}>AI+QM</span>
                        <span className={styles.regularText}>ENGINE</span>
                    </div>
                    <div className={styles.item}>
                        <span className={styles.bigText}>NEW</span>
                        <span className={styles.regularText}>READY</span>
                    </div>
                </div>
            </div>
        </div>
